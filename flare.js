...
// emblem randomizer
var emblems = ['triforce_.png', 'commodore.png', 'cherry.png'];
...
// emblems to preload :)
$.preloadImages("img/triforce_.png", "img/commodore.png", "img/cherry.png", "img/bg.png");

// next emblem ;)
function next() {
  if($(".emblem").attr("src") == "img/triforce_.png") {
    ...
    $(".emblem").fadeOut('2600',function(){$(this).attr('src',"img/triforce_.png").fadeIn('2600');});
  }
}
...
// link definitions
function mail() {
  window.location.href = "mailto:christian@starflare.info";
}
